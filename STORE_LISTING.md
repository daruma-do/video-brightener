...
## 拡張機能名
```
AutoLift - 動画の暗いシーンを明るく
```

## 概要（132文字以内）
```
YouTube・U-NEXT・ABEMAなどの動画で、暗くて見えにくいシーンを明るく補正します。明るさとコントラストを個別に調整可能、フルスクリーン対応、外部通信ゼロ。
```
※124文字
...
```markdown
■ こんな悩みを解決します
・YouTubeの実況動画で、暗いシーンが見えない
・U-NEXTやABEMAの映画・ドラマが暗すぎる
...
・有料配信のDRM動画でも動作（U-NEXT・ABEMAで動作確認済）

■ 対応サイト
YouTube／Twitch／ニコニコ動画／Vimeo／U-NEXT／ABEMA
